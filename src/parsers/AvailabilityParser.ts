...
export class AvailabilityParser {
	...
	public parseModelToPOJOWithSpecificCapabilities = (
		...
		let availabilityContent: AvailabilityContent = {};
		let availabilityOffers: AvailabilityOffers = {};
		let availabilityPickups: AvailabilityPickup = {};
		let availabilityPricing: AvailabilityPricing = {};
		let availabilityResources: AvailabilityResources = {};
