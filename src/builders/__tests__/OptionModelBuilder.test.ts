...
describe("OptionModelBuilder", () => {
  ...
  describe("build", () => {
    it.concurrent("should build option model without any capabilities", async () => {
    ...
    it.concurrent("should build option model with content capability", async () => {
      const generatedOptionModel = optionModelBuilder.build({
        optionData: OptionDataProvider.defaultOption,
        pricingPer: PricingPer.BOOKING,
    ...
    it.concurrent("should build option model with pickup capability", async () => {
      const generatedOptionModel = optionModelBuilder.build({
        optionData: OptionDataProvider.defaultOption,
        pricingPer: PricingPer.BOOKING,
    ...
    it.concurrent("should build option model with pricing capability", async () => {
      const generatedOptionModel = optionModelBuilder.build({
        optionData: OptionDataProvider.defaultOption,
        pricingPer: PricingPer.BOOKING,
    ...
    it.concurrent("should build option model with all capabilities", async () => {
      const generatedOptionModel = optionModelBuilder.build({
        optionData: OptionDataProvider.defaultOption,
        pricingPer: PricingPer.BOOKING,
    ...
    it.concurrent("should build option model with product as a source model", async () => {
      const generatedOptionModel = optionModelBuilder.build({
        optionData: OptionDataProvider.defaultOption,
        pricingPer: PricingPer.BOOKING,
        capabilities: [CapabilityId.Pricing],
